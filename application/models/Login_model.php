...
class Login_Model extends CI_Model
{
    ...
    public function checkUserByPin($loginPin,$mobInput='')
    {
        $query = "SELECT userId, isPinChanged, ifActive "
            ."FROM doolally_usersmaster "
            ."where userType IN(0,1,2,3,5,6,7,8,9,10) AND LoginPin = '".$loginPin."' AND (emailId LIKE '".$mobInput."' OR mobNum LIKE '".$mobInput."')";
